        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">Edit Official Station: {{ $officialStation->name }}</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('official-stations.update', $officialStation) }}" method="POST">
                        @csrf
                        @method('PUT')
                            ...
                            <select class="form-select @error('region_id') is-invalid @enderror" 
                                ...
                                @foreach($regions as $region)
                                    <option value="{{ $region->id }}" 
                                        {{ old('region_id', $officialStation->region_id) == $region->id ? 'selected' : '' }}>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('code') is-invalid @enderror" 
                                       id="code" name="code" value="{{ old('code', $officialStation->code) }}" required>
                                @error('code')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror" 
                                       id="name" name="name" value="{{ old('name', $officialStation->name) }}" required>
                                @error('name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('address') is-invalid @enderror" 
                                      id="address" name="address" rows="3" required>{{ old('address', $officialStation->address) }}</textarea>
                            @error('address')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('contact_number') is-invalid @enderror" 
                                       id="contact_number" name="contact_number" value="{{ old('contact_number', $officialStation->contact_number) }}">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="email" class="form-control @error('email') is-invalid @enderror" 
                                       id="email" name="email" value="{{ old('email', $officialStation->email) }}">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('officer_in_charge') is-invalid @enderror" 
                                       id="officer_in_charge" name="officer_in_charge" 
                                       value="{{ old('officer_in_charge', $officialStation->officer_in_charge) }}" required>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('officer_position') is-invalid @enderror" 
                                       id="officer_position" name="officer_position" 
                                       value="{{ old('officer_position', $officialStation->officer_position) }}" required>
                        ...
                        <div class="form-check mb-4">
                            <input class="form-check-input" type="checkbox" id="is_active" name="is_active" value="1"
                                {{ old('is_active', $officialStation->is_active) ? 'checked' : '' }}>
